...
public class EmployeeValidator {
    ...
    public static List<String> validate(Employee e, Boolean codeDuplicateCheckFlag, Boolean passwordCheckFlaf){

        //エラー項目を保存するコレクション（List型のインスタンス）を作成
        ...
        //パスワード確認
        String password_error = validatePassword(e.getPassword(), passwordCheckFlaf);{
    ...
    private static String validateCode(String code, Boolean codeDuplicateCheckFlag){
        ...
        if(codeDuplicateCheckFlag){
            ...
            //setParameterで社員番号をJPQLにセットして送信し、結果を取得する
